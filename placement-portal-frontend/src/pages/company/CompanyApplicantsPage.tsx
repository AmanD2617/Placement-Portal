  ...
  return (
    <section className="work-page">
      <article className="work-card">
        <h1>Applicants</h1>
        <p>Review applicants, view profiles & resumes, and update screening status.</p>
      </article>
        ...
        {loading ? (
          ...
          <>
            <p className="work-muted" style={{ marginBottom: '0.6rem', fontSize: '0.82rem' }}>
              Showing {filtered.length} of {applications.length} applicant
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p className="work-muted" style={{ fontSize: '0.82rem' }}>
                          {app.jobTitle} &middot; {app.company}
